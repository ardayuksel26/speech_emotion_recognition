...
MODEL_DIR    = os.path.join(PROJECT_ROOT, "Models_2", "RandomForest")
...
def train_rf():
    ...
    print(f"Random Forest Train Accuracy: %{accuracy_score(y, y_pred)*100:.2f}")
    ...
    joblib.dump(scaler, os.path.join(MODEL_DIR, "scaler_rf.pkl"))
    joblib.dump(le,     os.path.join(MODEL_DIR, "label_encoder_rf.pkl"))
