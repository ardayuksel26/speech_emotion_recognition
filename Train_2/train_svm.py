...
MODEL_DIR    = os.path.join(PROJECT_ROOT, "Models3", "SVM")
...
def train_svm():
    ...
    print(f"SVM Train Accuracy: %{accuracy_score(y, y_pred)*100:.2f}")
    ...
    joblib.dump(le,     os.path.join(MODEL_DIR, "label_encoder_svm.pkl"))
