...
MODEL_DIR    = os.path.join(PROJECT_ROOT, "Models_2", "GradientBoosting")
...
def train_gb():
    ...
    print(f"Gradient Boosting Train Accuracy: %{accuracy_score(y, y_pred)*100:.2f}")
    ...
    joblib.dump(scaler, os.path.join(MODEL_DIR, "scaler_gb.pkl"))
    joblib.dump(le,     os.path.join(MODEL_DIR, "label_encoder_gb.pkl"))
