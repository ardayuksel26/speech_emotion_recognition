...
MODEL_DIR    = os.path.join(PROJECT_ROOT, "Models_2", "CatBoost")
...
def train_catboost():
    ...
    print(f"CatBoost Train Accuracy: %{accuracy_score(y, y_pred)*100:.2f}")
    ...
    joblib.dump(scaler, os.path.join(MODEL_DIR, "scaler_catboost.pkl"))
    joblib.dump(le,     os.path.join(MODEL_DIR, "label_encoder_catboost.pkl"))
